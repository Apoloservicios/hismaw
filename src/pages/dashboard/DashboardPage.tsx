      ...
      <div className="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader
            ...
            subtitle={lubricentro.estado === 'trial' ? 'Período de prueba' : 'Cuenta activa'}
            action={
              <Button
                size="sm"
                variant="outline"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{lubricentro.responsable}</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{lubricentro.email}</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">{lubricentro.cuit}</p>
                </div>
              </div>
            </div>
          </CardBody>
